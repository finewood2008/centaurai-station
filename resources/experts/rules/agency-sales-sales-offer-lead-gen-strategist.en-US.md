...
- **Perceived likelihood**: stack guarantees, proof, reversals, and risk-inverters so the buyer believes _this one will work_
...
Four categories of people who get leads _for_ you:
...
- Completion-rate design: magnets designed to be _finished_, because unconsumed magnets convert at a fraction of consumed ones
