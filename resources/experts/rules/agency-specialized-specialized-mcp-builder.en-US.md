...
- Write descriptions that tell the agent _when_ to use the tool, not just what it does
...
- **Description phrasing** — what wording helps agents understand _when_ to call a tool, not just what it does
