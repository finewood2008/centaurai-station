...
// ---------------------------------------------------------------------------
export type DiscoveredServerInfo = {
  name: string;
  host: string;
  port: number;
  addresses: string[];
...
export const discovery = {
  /** Browse the LAN for CentaurAI servers for `timeoutMs` (default 3000). */
  list: bridge.buildProvider<DiscoveredServerInfo[], { timeoutMs?: number } | undefined>('discovery.list'),
};
