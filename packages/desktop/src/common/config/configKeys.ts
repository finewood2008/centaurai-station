...
export type ConfigKeyMap = {
  ...
  'tools.imageGenerationProviders': ImageGenProvider[] | undefined;
  'tools.voiceProviders': ImageGenProvider[] | undefined;
  'tools.videoProviders': ImageGenProvider[] | undefined;
