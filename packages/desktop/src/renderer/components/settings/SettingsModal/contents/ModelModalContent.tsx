...
const ModelModalContent: React.FC = () => {
  ...
  useEffect(() => {
    if (imageProviderId || !data?.length) return;
          ...
          <div className='space-y-16px'>
            <div className='rounded-12px border border-solid border-[var(--color-border-2)] bg-[var(--color-bg-2)] p-14px'>
              <div className='flex flex-col gap-4px mb-14px'>
                <div className='text-15px font-600 text-t-primary'>{t('settings.imageModelsTitle')}</div>
                <div className='text-12px text-t-secondary'>{t('settings.imageModelsDescription')}</div>
              </div>
              ...
              <div className='mt-14px flex flex-col gap-6px'>
                ...
                {imageModelProviders.length > 0 ? (
                  ...
                  <div className='text-13px text-t-secondary rounded-8px border border-dashed border-[var(--color-border-2)] px-12px py-10px'>
