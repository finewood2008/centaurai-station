...
export function buildRedTeamPrompt(params: { topic: string; persona: string; lens?: string; draftContext: string }): string {
...
export function buildProposalPrompt(params: { topic: string; persona: string; lens?: string; reference?: string }): string {
...
export function buildConvergePrompt(params: { topic: string; persona: string; lens?: string; clustersContext: string }): string {
