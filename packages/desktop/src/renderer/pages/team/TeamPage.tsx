...
const AgentChatSlot: React.FC<{
  ...
  onRemove?: () => void;
}> = ({ agent, team_id, isLeader, isFullscreen = false, hideSendBox = false, onToggleFullscreen, onRemove }) => {
...
const TeamPageContent: React.FC<TeamPageContentProps> = ({ team, onRenameTeam, viewMode, onChangeViewMode }) => {
      ...
      <ChatLayout
        ...
        headerExtra={
          <div className='flex items-center gap-8px'>
            <TeamSharedContextSwitch />
            <TeamViewModeSwitch viewMode={viewMode} onChange={onChangeViewMode} />
          </div>
        }
      >
        {viewMode === 'meeting' ? (
